                                ...
                                <form class="row" style="margin-top:20px" method="post" action="process/createProcess.php">
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="cFee">Cleaning Fee</label>
                                                    <input type="number" name="cFee" class="form-control" id="cFee" placeholder="Enter cleaning fee">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="cPercent">Commission Percentage</label>
                                                    <input type="number" name="cPercent" class="form-control" id="cPercent" placeholder="Enter comission percentage">
                                                </div>
                                            </div>
                                            <div class="form-group">
